...
export async function stockItem() {
  await prisma.stockItem.createMany({
    data: [
      ...
      { sku: 'SB1', name: 'Coffee Beans', category: StockCategory.COFFEE, quantityAvailable: 10, purchasePrice: 450, sellingPrice: 500, stockLevelThreshold: 20, standardReorderQuantity: 50, popularityScore: Math.random() * stockPopularityScale }, // 450 THB/kg
      ...
      { sku: 'SB4', name: 'Loose-leaf Tea', category: StockCategory.TEA, quantityAvailable: 5, purchasePrice: 360, sellingPrice: 400, stockLevelThreshold: 10, standardReorderQuantity: 30, popularityScore: Math.random() * stockPopularityScale }, // 360 THB/kg
      { sku: 'SB5', name: 'Tea Bags', category: StockCategory.TEA, quantityAvailable: 20, purchasePrice: 15, sellingPrice: 20, stockLevelThreshold: 50, standardReorderQuantity: 100, popularityScore: Math.random() * stockPopularityScale }, // 15 THB/bag
      ...
      { sku: 'SB7', name: 'Thai Tea Mix', category: StockCategory.TEA, quantityAvailable: 10, purchasePrice: 240, sellingPrice: 280, stockLevelThreshold: 20, standardReorderQuantity: 50, popularityScore: Math.random() * stockPopularityScale }, // 240 THB/kg
      ...
      { sku: 'SB15', name: 'Caramel Syrup', category: StockCategory.FLAVORING, quantityAvailable: 7, purchasePrice: 150, sellingPrice: 165, stockLevelThreshold: 20, standardReorderQuantity: 40, popularityScore: Math.random() * stockPopularityScale }, // 150 THB/liter
      ...
      { sku: 'SB18', name: 'Bananas', category: StockCategory.FRUIT, quantityAvailable: 10, purchasePrice: 30, sellingPrice: 35, stockLevelThreshold: 20, standardReorderQuantity: 40, popularityScore: Math.random() * stockPopularityScale }, // 30 THB/kg
      ...
      { sku: 'SB21', name: 'Pineapples', category: StockCategory.FRUIT, quantityAvailable: 0, purchasePrice: 105, sellingPrice: 120, stockLevelThreshold: 12, standardReorderQuantity: 25, popularityScore: Math.random() * stockPopularityScale }, // 105 THB/kg
      ...
      { sku: 'SB29', name: 'Pistachios', category: StockCategory.NUTS, quantityAvailable: 5, purchasePrice: 210, sellingPrice: 230, stockLevelThreshold: 5, standardReorderQuantity: 10, popularityScore: Math.random() * stockPopularityScale }, // 210 THB/kg

      // Grain (Prices in Thai Baht)
      { sku: 'SB30', name: 'Flour', category: StockCategory.GRAIN, quantityAvailable: 10, purchasePrice: 90, sellingPrice: 100, stockLevelThreshold: 20, standardReorderQuantity: 50, popularityScore: Math.random() * stockPopularityScale }, // 90 THB/kg
      ...
      { sku: 'SB38', name: 'Ice Cubes', category: StockCategory.ICE, quantityAvailable: 20, purchasePrice: 15, sellingPrice: 20, stockLevelThreshold: 50, standardReorderQuantity: 100, popularityScore: Math.random() * stockPopularityScale }, // 15 THB/kg
      ...
      { sku: 'SB40', name: 'Cups', category: StockCategory.PACKAGING, quantityAvailable: 50, purchasePrice: 3, sellingPrice: 4, stockLevelThreshold: 100, standardReorderQuantity: 200, popularityScore: Math.random() * stockPopularityScale }, // 3 THB/unit
